...
namespace E3D {
    ...
    void Pipeline::createGraphicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo) {
        assert(
                ...
                "Cannot create graphics m_pipeline: no m_vkPipelineLayout provided in config info");
        assert(
                configInfo.renderPass != VK_NULL_HANDLE &&
                "Cannot create graphics m_pipeline: no renderPass provided in config info");
